...
v18 native server: **4,400,128 bytes**, SHA-256 `1cec67125538c3c458759de78afd079d4114d26f465cfaeb2527aeee29c3ac5e`. Linux server: **4,889,712 bytes**, SHA-256 `9f0eb3fbf5d710fb112699ebee4a72ccebfa5e5ed7a5b363febf0468ca6be734`. No new normal dependency, download, production caller or MCP tool. An invalid copied fixture was corrected against its validated source; test lint findings were fixed without suppression. The earlier architecture gate recovered only its owned temporary Cargo cache after checking 267 cached package archive checksums; repository/user data was not removed. The existing Linux proc-macro-error2 future-compatibility warning remains visible. No macOS/MSVC, physical-router, real backup/storage or new resource benchmark is claimed.

The **v17 gzip archive increment** follows architecture-only `e72e685361e86f90516d3985c06ef749ce124bb2` (495 native Windows GNU / 516 Linux-on-WSL tests). Implementation gates pass **510 / 531 distinct tests**, zero ignored and **97 harness regressions** counted once. Fifteen gzip tests bring the required action-response suite to 41; independent host producers pass eight positive and four expected-negative combinations. [Scope, bounds and interoperability restrictions](gzip-archive-validation.md) include deliberate rejection of bsdtar's compressed stdout padding. No application consumer or new MCP operation is introduced.

v17 native server: **4,400,128 bytes**, SHA-256 `960462bb1f2c3d8793dfb2262095c8ef40672c80d740dbd0452f5c358a283514`. Linux server: **4,889,712 bytes**, SHA-256 `9f0eb3fbf5d710fb112699ebee4a72ccebfa5e5ed7a5b363febf0468ca6be734`. Both full gates pass architecture/evolution, formatting, all-target Clippy, workspace tests and release builds. The pinned flate2/zlib-rs edge reuses existing locked crates; no new download. The existing proc-macro-error2 warning remains unsuppressed. No measured RSS/latency, macOS/MSVC, OpenWrt backup/restore or full-management claim follows.

The **v16 supplied archive-codec increment** follows architecture-only `6c3e2564459ab78fce7ff418c07bebf6062d2631`, validated with 475 native Windows GNU / 496 Linux-on-WSL tests before behavior. Implementation full gates pass **490 / 511 distinct tests**, zero ignored and **92 harness regressions** counted once. Fifteen new parser/manifest/stream tests and eight independent Windows/Linux tar-producer/validator combinations pass. [Exact scope and fixture evidence](backup-archive-validation.md) distinguish structural validation from backup completeness, provenance, encryption and restoration. No production consumer or new management operation is introduced.

v16 native server: **4,400,128 bytes**, SHA-256 `81d61f40f5407c8ed78ab6d41a6232168eb2d38f49e0edd4ccf39c60d0c777f0`. Linux server: **4,889,712 bytes**, SHA-256 `4e1be23288b0882e1552be41e2a180826c7be27d12c92273864caf47a73c5541`. Architecture/evolution, format, strict all-target Clippy, workspace tests and release builds pass. The zeroize edge reuses the locked dependency; no new downloaded crate. Native macOS/MSVC, actual OpenWrt archive/backup, whole management and new resource-performance claims remain unverified.

The **v15 pure effect-model increment** follows architecture-only `8adc3278df83289bff7529fb483c90edbbe1db49`, whose full gates passed 455 native Windows GNU / 476 Linux-on-WSL tests before behavior. Optimized implementation gates pass **470 distinct native Windows GNU tests**, **491 Linux-on-WSL tests**, zero ignored and **87 harness regressions** counted once. Fifteen new behavioral tests include 3,584 independent small-model comparisons, order/denial properties, mixed before/after node layouts and maximum individual/union resource limits. A separate development-only microbenchmark drove an optimization from per-edge string searches to direct sorted merging; [measurement conditions/results](protected-resource-effects.md) do not establish device or end-to-end performance. No production consumer, extra management tool, actual topology assertion, mutation permit or I/O was added.

v15 native release: **4,400,128 bytes**, SHA-256 `ebee6adcae425006711e08746bba1eb44549f6a0d15e59b3ddbb573249d2c43c`. Linux release: **4,889,712 bytes**, SHA-256 `0a5973505ff01d8b02242870cf621320ea32b4feb734ab89ef60e29230f434f0`. Full gates pass architecture/evolution, formatting, strict all-target Clippy including the synthetic example, workspace tests and release compilation. Historical records below retain their original artifact hashes and operation scope. Catalog remains 51 reads plus capability metadata; native macOS/MSVC, device deployment and full management remain unverified.

Separate [v14 opkg emulator acceptance](emulator-validation-v14.md) on official 24.10.4 enumerated 196 root-status records in 13 pages, verified replay/refresh/cross-manager invalidation, safe APK unavailability and 50 correlated audit events. This is explicitly Linux-host SSH and scoped userspace evidence, not native Windows/macOS or BPI-R4 hardware acceptance.

The **v14 opkg root-status increment** follows architecture-only `2233f3e83a63313e98bcf9413c3efa78ea6ee042`, validated on native Windows GNU and Linux-on-WSL before production changes. Both implementation gates pass: **450 distinct native Windows GNU tests**, **471 Linux-on-WSL tests**, zero ignored and **82 harness regressions** counted once. The 51-read catalog retains forty typed projection contracts and now has two source-specific package workflows. Fourteen new tests plus expanded existing runtime/MCP tests cover exact recipes and banners, strict full-file validation, field/line/stanza/record/retained bounds, opaque status, both managers' pagination, cross-profile/replacement/cancellation/epoch behavior, wrong backend profiles, audit failures and SSH deadlines/completion. No new dependency or ownership bypass is introduced. See [opkg contract](opkg-observations.md).

Native release: **4,400,128 bytes**, SHA-256 `2441527d8bad1890351db35354f46ae7cc65f081618911e22cf7c41878c8cc16`. Linux release: **4,889,712 bytes**, SHA-256 `f55f254b5e2d53a7cf36afea834f6b6b0a823993f1683dc36c215af95086fcd1`. Full gates pass architecture/evolution, formatting, strict all-target Clippy, workspace tests and release compilation. The existing proc-macro-error2 2.0.1 future-incompatibility warning remains unsuppressed. No new CPU/RSS/latency, native macOS/MSVC or physical-router claim follows. Historical milestones below retain their original scope/counts.

The **v13 base-service UCI increment** follows architecture-only `fe677cb2674b900972b1a1b219cc4bb6e8d9013c`, whose full native Windows GNU and Linux-on-WSL gates passed before behavior. Implementation gates pass **433 distinct native Windows GNU tests** and **454 Linux-on-WSL tests**, zero ignored; **79 harness regressions** counted once. Eighteen new fixed reads bring the catalog to 50 reads/40 typed contracts and 24 closed UCI recipes. Independent exact action/category/field/version fixtures and documentation parity cover all additions. Existing cross-category, custom-UCI, malformed/root-error/type/row/option/byte-budget tests now exercise all 24 recipes. MCP tests enforce metadata, authorization-before-I/O, fixed arguments, safe errors and payload-free audit. No projection form, resource ceiling, dependency or owner changed. See [base UCI contracts](base-uci-observations.md).

Native release: **4,372,480 bytes**, SHA-256 `5f0f9b50fe9c864f2a4bdb64bec4e9763a489c40433ab3bb6b08af31086e27b7`. Linux release: **4,861,040 bytes**, SHA-256 `c1c495eee23e01262ba66501d227a57c735bc6aa5d954b502d49b1bc6af33b81`. Both full gates pass architecture/evolution, formatting, strict all-target Clippy, workspace tests and release compilation. The existing proc-macro-error2 2.0.1 future-incompatibility warning remains unsuppressed. No new RSS/CPU/latency measurement or full-host/full-management claim follows.

Separate [v13 emulator acceptance](emulator-validation-v13.md) exercises all eighteen additions through actual MCP/SSH on the isolated official 25.12.5 ARM64 image. Fixed synthetic pending RAM sections and baseline rows passed exact field/form/bound checks; 90 invalid arguments and 198 safe audit events passed. Only actually observed fields have emulated evidence. No settings were committed or applied, and no physical router was accessed. VM/listener cleanup was independently confirmed.

The **v12 text-option increment** follows architecture-only `6c45623914ef327d6e8e007f8644e22905eda620`, which passed both full host gates before behavior. Implementation gates pass **426 distinct native Windows GNU tests** and **447 Linux-on-WSL tests**, zero ignored; **75 harness regressions** counted once. The catalog remains 32 reads/22 typed contracts. Network-interface and dnsmasq configuration response IDs become v2; other UCI IDs remain v1. New core/feature/dispatcher/MCP cases distinguish absent/empty string/empty list/duplicate lists, validate terminal nested-only admission, exact UTF-8/individual/shared row and schema bounds, unselected malformed data, and exact 65536-byte normalized output including representation wrappers. Core UCI still rejects every other nested collection and all custom UCI definitions. Fixed actions, categories, probes, dependencies, byte ceilings and audit paths remain unchanged. See [text/list contract](uci-observations.md).

Native release: **4,360,192 bytes**. The test fixture boundary, host protection/age/SSH/protocol suites, strict all-target Clippy and release builds pass without exclusions. No new RSS/CPU/latency or full-platform/full-management claim follows; previous emulator evidence retains its original response version.

Separate [v12 emulator acceptance](emulator-validation-v12.md) verifies the two v2 configuration responses through actual MCP/SSH, including all ten selected string/list fields in two fixed synthetic pending RAM sections. Network/dnsmasq observations contained 3/2 rows and 11/11 total items. Thirty argument rejections and 66 safe audit events passed. No staged configuration was committed or applied; the physical router was untouched. The initial private fixture setup failed, then the same setup split into bounded commands passed without relaxing production or test requirements. Radio/fstab remained safe unavailable/error evidence only.

The **v11 closed UCI increment** follows architecture-only `0b581eaceedfe81a8fd214b5df6875cc9633ccce`, whose native Windows GNU and Linux-on-WSL full gates passed with unchanged production behavior. Implementation full gates pass **410 distinct native Windows GNU tests** and **431 Linux-on-WSL tests**, zero ignored; **70 harness regressions** are counted once. Six new typed tools bring the catalog to 32 (22 typed). Core enforces fixed config/type/get recipes, exact category Read requirements, required type guards and custom-UCI rejection before the tenth probe object becomes usable. Exact finite text enums reuse existing byte/row limits and borrowed scalar evaluation. New negative/catalog/dispatcher/MCP fixtures cover privileged custom bypass attempts, malformed/error/wrong-type responses, optional scalar/list mismatch, metadata and UTF-8/row/byte bounds, fixed actions, category isolation and payload-free audit. See [UCI observations](uci-observations.md).

Both first full-gate attempts exposed a test-fixture construction bug when inserting absent TOML enum metadata into the v10 downgrade fixture. Explicit table insertion fixed the fixture; the older registry remains isolated and the exact downgrade rejection assertion is preserved. Neither architecture rules nor production checks were weakened. Native release: **4,340,224 bytes**. No new RSS/CPU/latency, hardware, macOS or Windows-to-router claim follows from host tests.

Separate [v11 MCP/SSH emulator acceptance](emulator-validation-v11.md) validated system/network/firewall/dnsmasq configuration rows (1/2/1/1), thirty invalid-argument rejections and 66 safe audit events. Wireless and mount configuration calls returned safe backend failures despite compatible input signatures; these are negative evidence, not successful reads or proof of absent configuration. Only the observed option fields have emulator evidence. No actual configuration payload was retained; the isolated VM/listener were stopped.

The **subsequent interface-IP increment within v10** passes **396 distinct native Windows GNU tests** and **417 Linux-on-WSL tests**, zero ignored. **65 harness regressions** are counted once. Four typed tools bring the catalog to 26; no new production boundary, probe, dependency, projector form or resource ceiling. Existing suites cover exact local selection, category isolation, declared address/route/neighbor/DNS fields, optional/empty/malformed lists, duplicate rows, unselected source validation, numeric/text/global byte limits and payload-free MCP/audit. The feature contract preceded implementation; see [interface IP scope](interface-ip-observations.md).

Full-gate validation exposed a harness defect: Cargo integration-test/example crate roots were incorrectly resolved using a non-root file's stem. The harness now derives exact roots from already validated Cargo target metadata. Two assembled regressions cover valid Rust layouts plus missing, wrong, ambiguous and fake-root paths; production descendants still receive recursive forbidden-API checks. No source/test exclusion, path override or architecture-contract weakening was added. The native release is 4,321,280 bytes; new RSS/CPU/latency and hardware acceptance are not implied.

Separate [v10 MCP/SSH emulator acceptance](emulator-validation-v10.md) exercised the four interface-IP reads on loopback and lan, three mount rows, and empty block/IPv4/IPv6 lease collections. All current response IDs and field/type bounds passed, with 16 negative cases and 68 safe audit events. Populated IPv6/route/neighbor/DNS/lease/block cases remain synthetic only. The isolated VM/listener were stopped; this does not establish BPI-R4 or Windows/macOS-to-device acceptance.

The **v10 finite observation/DHCP increment** follows architecture-only `4040ce3`, which passed both host gates before behavior. Full implementation gates pass **389 distinct native Windows GNU tests** and **410 Linux-on-WSL tests**, zero ignored; **63 harness regressions** are counted once. New core/catalog/dispatcher/MCP cases cover duplicate-preserving rows, exact false/integer sentinels, bounded root-absence guards, nested shared budgets, fixed family actions, category isolation and payload-free audit. The catalog has 22 reads and twelve typed contracts; storage response IDs become v2 without changing successful fields. See [DHCP scope](dhcp-observations.md) and [storage scope](storage-observations.md). This is synthetic host acceptance, not actual lease files, complete DNS/DHCP, emulator or BPI-R4 acceptance. The native release is 4,309,504 bytes; no new RSS/CPU/latency measurement was made.
