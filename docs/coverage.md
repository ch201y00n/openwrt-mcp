...
| wireless | wireless_radio_info, wireless_devices | rpcd-mod-iwinfo/libiwinfo and supported driver; bounded device-name list and selected radio scalars, no SSID/BSSID/keys/client list; empty devices do not prove no radios |
